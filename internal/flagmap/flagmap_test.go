...
func TestFlagToSchemaPath(t *testing.T) {
	tests := []struct {
		...
		// South Korea
		{"korea-bank-code", "beneficiary.bank_details.account_routing_value1", "bank_code"},
		// Singapore PayNow
		{"paynow-vpa", "beneficiary.bank_details.account_routing_value1", "virtual_payment_address"},
		{"uen", "beneficiary.bank_details.account_routing_value1", "business_registration_number"},
		{"nric", "beneficiary.bank_details.account_routing_value1", "personal_id_number"},
		{"sg-bank-code", "beneficiary.bank_details.account_routing_value1", "bank_code"},
		// Sweden
		{"clearing-number", "beneficiary.bank_details.account_routing_value1", "bank_code"},
		// Hong Kong FPS
		{"hk-bank-code", "beneficiary.bank_details.account_routing_value1", "bank_code"},
		{"fps-id", "beneficiary.bank_details.account_routing_value1", "fps_identifier"},
		{"hkid", "beneficiary.bank_details.account_routing_value1", "personal_id_number"},
		// Australia PayID/NPP
		{"payid-phone", "beneficiary.bank_details.account_routing_value1", "phone_number"},
		{"payid-email", "beneficiary.bank_details.account_routing_value1", "email_address"},
		{"payid-abn", "beneficiary.bank_details.account_routing_value1", "australian_business_number"},
		// Brazil tax IDs
		...
		// China legal representative (for business)
		{"legal-rep-first-name", "beneficiary.additional_info.legal_rep_first_name", ""},
